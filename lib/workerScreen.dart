...
import 'package:workers_employment/Worker/searchJob.dart';
import 'package:workers_employment/customerCare.dart';
import 'package:workers_employment/history.dart';
...
class WorkerScreen extends StatefulWidget
{
  ...
  const WorkerScreen({Key key, this.user, this.name, this.phone}) : super(key: key);
...
class _WorkerScreenState extends State<WorkerScreen>
{
  ...
  [
    ...
    WorkerAddJob(user: user2,phone: phone2,name: name2,),

    WorkerHomePage(user: user2,name:name2 ,phone: phone2,),
  ...
  Widget build(BuildContext context)
  {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text(_selectedIndex==0?"Add Skills":_selectedIndex==1?"Home":"History"),
